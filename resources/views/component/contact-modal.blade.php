...
<div id="contactModal" class="fixed inset-0 z-[100] hidden">
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        <div class="relative bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:max-w-lg w-full">
            ...
            <!-- Close Button -->
            <button onclick="closeContact()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition-colors">
            ...
            <div class="bg-white px-8 pt-8 pb-8">
                ...
                <div class="mt-4">
                    <input type="email" placeholder="Enter your email..." class="w-full border border-gray-300 px-4 py-3 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 focus:outline-none transition-all duration-300 shadow-sm mb-4">
                    <textarea placeholder="Enter your message (optional)..." rows="3" class="w-full border border-gray-300 px-4 py-3 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 focus:outline-none transition-all duration-300 shadow-sm"></textarea>
                </div>
            </div>
            
            <div class="bg-gray-50 px-8 py-4 sm:flex sm:flex-row-reverse border-t border-gray-100">
                <button type="button" onclick="closeContact()" class="w-full inline-flex justify-center rounded-xl border border-transparent shadow-sm px-6 py-3 bg-gray-900 text-base font-medium text-white hover:bg-amber-600 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 sm:ml-3 sm:w-auto sm:text-sm transition-all duration-300 active:scale-95">
                    Submit
                </button>
