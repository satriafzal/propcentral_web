                ...
                <form action="{{ route('password.update') }}" method="POST">
                    ...
                    <div class="reset-form-group">
                        ...
                        <div class="reset-input-wrapper">
                            <input type="password" name="password" class="reset-input" id="password" placeholder="••••••••" required>
                    ...
                    <div class="reset-form-group">
                        ...
                        <div class="reset-input-wrapper">
                            <input type="password" name="password_confirmation" class="reset-input" id="password_confirmation" placeholder="••••••••" required>
