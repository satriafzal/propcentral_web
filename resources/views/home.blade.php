...
{{-- HERO --}}
<section class="px-10 py-10 flex items-center justify-between bg-[#f0e6dd] overflow-hidden">
    <div>
        ...
        <button onclick="openLogin()" class="bg-black text-white px-6 py-2 rounded inline-block">
            Login
        </button>
    </div>
    
    <img src="{{asset('assets/images/imagehome.png')}}" class="w-[600px] block">
</section>
