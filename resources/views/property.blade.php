...
<script>
    ...
    function allProperties() {
        @php
        $allProps = [
            ['id'=>'obsidian',  'img'=>'property_obsidian.png',  'badge'=>'Dijual',    'price'=>'$2,450,000', 'title'=>'The Obsidian Retreat',    'loc'=>'Beverly Hills, CA',   'specs'=>'5 K. Tidur, 4 K. Mandi, 4,200 sqft'],
            ['id'=>'penthouse', 'img'=>'property_penthouse.png', 'badge'=>'Penawaran Menarik',    'price'=>'$890,000',   'title'=>'Skyline Penthouse',        'loc'=>'Upper West Side, NY', 'specs'=>'2 K. Tidur, 2 K. Mandi, 1,850 sqft'],
            ['id'=>'azure',     'img'=>'property_azure.png',     'badge'=>'Terbaru', 'price'=>'$1,720,000', 'title'=>'Azure Waters Residence',   'loc'=>'Malibu, CA',          'specs'=>'4 K. Tidur, 3 K. Mandi, 3,100 sqft'],
        ];
        @endphp
        return {!! json_encode($allProps) !!};
    }
...
<section class="bg-[#faf9f8] pb-20 px-10 fade-in-section">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex flex-col gap-6 mb-12">
            ...
            <div onclick="requireLogin(event)"
                ...
                <div class="w-full md:w-[40%] relative overflow-hidden h-64 md:h-auto">
                    <img src="{{ asset('assets/images/' . $prop['img']) }}"
                ...
                <div class="w-full md:w-[60%] p-8 flex flex-col justify-center">
                    ...
                    <div class="text-gray-600 text-sm font-medium">{{ $prop['specs'] }}</div>
                </div>
            </div>
            @endforeach
